...
function getErrorMessage(errorCode) {
    const errorMessages = {
        ...
        'auth/unauthorized-domain': 'Dominio no autorizado. Agrégalo en Firebase Console > Auth > Settings'
    };

    return errorMessages[errorCode] || `Ocurrió un error (${errorCode}). Intenta nuevamente`;
}
